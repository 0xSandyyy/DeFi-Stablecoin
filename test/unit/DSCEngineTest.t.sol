...
contract DSCEngineTest is StdCheats, Test {
    ...
    function setUp() external {
        ...
        // minting our user some weth and wbtc
    ...
    function testRevertsWithUnapprovedCollateral() public {
        ...
        vm.startPrank(user);
        vm.expectRevert(abi.encodeWithSelector(DSCEngine.DSCEEngine__NotAlowedToken.selector, address(randToken)));
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        amountToMint =
            (amountCollateral * (uint256(price) * dsce.getAdditionalPriceFeedPrecision())) / dsce.getPrecision();
        vm.startPrank(user);
        // approving our contract with weth token and some initial collateral
        // without this our contract will have no weth token with collateral value
        ERC20Mock(weth).approve(address(dsce), amountCollateral);
